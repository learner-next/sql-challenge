...
INSERT INTO `class_info` (id, name, teacher) VALUES (1, 'Math', 'Mr. Smith');
INSERT INTO `class_info` (id, name, teacher) VALUES (2, 'English', 'Mrs. Jones');
INSERT INTO `class_info` (id, name, teacher) VALUES (3, 'Science', 'Mr. Johnson');
INSERT INTO `class_info` (id, name, teacher) VALUES (4, 'History', 'Mrs. Williams');
